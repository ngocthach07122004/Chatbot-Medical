...
class PaperRetriever:
    def __init__(self, model_path: str = None, use_pretrained: bool = False, device: str = None):
        if device is None:
        ...
        if model_path and not use_pretrained:
            ...
            print("checkpoint", checkpoint.get('epoch', 'unknown'))
        elif use_pretrained:
            print("checkpoint", 0)
    ...
    def search(self, patient_text: str, top_k: int = 10, metric_type: str = "COSINE") -> List[Dict]:
    ...
    def batch_search(self, patient_texts: List[str], top_k: int = 10, metric_type: str = "COSINE") -> List[List[Dict]]:
        results = []
